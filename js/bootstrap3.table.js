/**
 * Created by johnnie on 2018/3/5.
 * 自定义 table 插件
 * 依赖库:
 *  1) bootstrap
 */
(function ($) {
    $.fn.table = function (config) {
        ...
        function getCaption() {
            if (config.caption) {
                var caption = '<div class="panel-heading">' + config.caption + '</div>';
                return caption;
            }
        }
        ...
        function getTableFoot() {
            if (config.pagination) {
                ...
                var tfoot = '<tfoot>'
                    ...
                    + '<li><a href="#" aria-label="Start">首页</a></li>'
                    + '<li class="disabled" aria-label="Previous"><span data-toggle="tooltip" data-placement="top" title="上一页" aria-hidden="true">&laquo;</span></li>'
                    + '<li><a class="current" href="#">1</a></li>'
                    + '<li><a href="#">2</a></li>'
                    + '<li><a href="#" aria-label="Next" data-toggle="tooltip" data-placement="top" title="下一页"><span aria-hidden="true">&raquo;</span></a></li>'
                    + '<li><a href="#" aria-label="End">尾页</a></li>'
                    + '</ul>'
                    + '</nav>'
                    + '</td>'
                    + '</tr>'
        ...
        var $modals = {
            delete: {
                ...
                html: '<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">'
                        ...
                        + '<button type="button" class="bs-close btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i>&nbsp;关闭</button>'
